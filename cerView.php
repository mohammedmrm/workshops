...
$sql = "select workshops.*,categories.id as cat_id, offices.name as office ,workshops.name as workshop,categories.name as cat,
        ...
        where workshops.id = ? limit 1";
$data = getData($con, $sql, [$workshop_id]);
